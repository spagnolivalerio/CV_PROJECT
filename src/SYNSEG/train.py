...
PRINT_EVERY = 10
WEIGHTS_DIR = "weights"
CHECKPOINT_NAME = "synseg_WGAN.pt"
...
# Datasets loading
train_dataset = DentalDataset(str(TRAIN_IMGS_DIR), str(TRAIN_MASKS_DIR), augment=True)
val_dataset = DentalDataset(str(VAL_IMGS_DIR), str(VAL_MASKS_DIR), augment=False)
...
for epoch in range(NUM_EPOCHS):
    ...
    checkpoint_path = f"{WEIGHTS_DIR}/{CHECKPOINT_NAME}"
